...
- Retrieves all ticker data from the previous open day ( monday - friday) data are not available during the we, as the current day's data is unavailable with the free plan.
